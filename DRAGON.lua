...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴊᴀʙᴡᴀ',url="t.me/s_e_z_r0"},{text = '• ʙᴏᴛ ᴊᴀʙᴡᴀ', url="t.me/ujbhbot"}},
...
if text == 'المبرمج كريم' or text == 'عمر' or text == 'كركر' or text == '³مبرمج السورس' then
local Text = [[
...
if text == 'المبرمج شادو' or text == 'شادو' or text == 'محمد' or text == '⁴مبرمج السورس' or text == 'سكران' or text == 'هتلر' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴊᴀʙᴡᴀ',url="t.me/s_e_z_r0"},{text = '• ᴅᴇᴠ ᴛᴀʜᴀ', url="t.me/TahaSayed9"}},
